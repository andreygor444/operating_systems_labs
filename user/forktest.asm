...
forktest(void)
{
  ...
  3e:	41650513          	addi	a0,a0,1046 # 450 <add+0xc>
  ...
  68:	3fc50513          	addi	a0,a0,1020 # 460 <add+0x1c>
  ...
  b8:	3fc50513          	addi	a0,a0,1020 # 4b0 <add+0x6c>
  ...
  d4:	3b050513          	addi	a0,a0,944 # 480 <add+0x3c>
  ...
  ee:	3ae50513          	addi	a0,a0,942 # 498 <add+0x54>
