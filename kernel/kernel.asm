...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002d9a:	77258593          	addi	a1,a1,1906 # 80008508 <syscalls+0xb8>
    80002d9e:	00014517          	auipc	a0,0x14
    80002da2:	c0a50513          	addi	a0,a0,-1014 # 800169a8 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    80002db2:	bfa78793          	addi	a5,a5,-1030 # 8001e9a8 <bcache+0x8000>
    80002db6:	0001c717          	auipc	a4,0x1c
    80002dba:	e5a70713          	addi	a4,a4,-422 # 8001ec10 <bcache+0x8268>
    80002dbe:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002dc2:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002dc6:	00014497          	auipc	s1,0x14
    80002dca:	bfa48493          	addi	s1,s1,-1030 # 800169c0 <bcache+0x18>
    ...
    80002dd6:	73ea0a13          	addi	s4,s4,1854 # 80008510 <syscalls+0xc0>
    b->next = bcache.head.next;
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80002e2a:	b8250513          	addi	a0,a0,-1150 # 800169a8 <bcache>
    80002e2e:	ffffe097          	auipc	ra,0xffffe
    80002e32:	da8080e7          	jalr	-600(ra) # 80000bd6 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80002e36:	0001c497          	auipc	s1,0x1c
    80002e3a:	e2a4b483          	ld	s1,-470(s1) # 8001ec60 <bcache+0x82b8>
    80002e3e:	0001c797          	auipc	a5,0x1c
    80002e42:	dd278793          	addi	a5,a5,-558 # 8001ec10 <bcache+0x8268>
    ...
    80002e6a:	b4250513          	addi	a0,a0,-1214 # 800169a8 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    80002e88:	dd44b483          	ld	s1,-556(s1) # 8001ec58 <bcache+0x82b0>
    80002e8c:	0001c797          	auipc	a5,0x1c
    80002e90:	d8478793          	addi	a5,a5,-636 # 8001ec10 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002ea8:	67450513          	addi	a0,a0,1652 # 80008518 <syscalls+0xc8>
    ...
    80002ec8:	ae450513          	addi	a0,a0,-1308 # 800169a8 <bcache>
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002f38:	5fc50513          	addi	a0,a0,1532 # 80008530 <syscalls+0xe0>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002f70:	a3c50513          	addi	a0,a0,-1476 # 800169a8 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    80002f98:	a1478793          	addi	a5,a5,-1516 # 8001e9a8 <bcache+0x8000>
    80002f9c:	2b87b703          	ld	a4,696(a5)
    80002fa0:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    80002fa2:	0001c717          	auipc	a4,0x1c
    80002fa6:	c6e70713          	addi	a4,a4,-914 # 8001ec10 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80002fba:	9f250513          	addi	a0,a0,-1550 # 800169a8 <bcache>
    ...
    80002fd6:	56650513          	addi	a0,a0,1382 # 80008538 <syscalls+0xe8>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002ff2:	9ba50513          	addi	a0,a0,-1606 # 800169a8 <bcache>
  ...
  release(&bcache.lock);
    ...
    80003008:	9a450513          	addi	a0,a0,-1628 # 800169a8 <bcache>
...
bunpin(struct buf *b) {
  ...
  release(&bcache.lock);
    ...
    80003044:	96850513          	addi	a0,a0,-1688 # 800169a8 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    80003070:	0187a783          	lw	a5,24(a5) # 8001f084 <sb+0x1c>
...
00000000800030d6 <balloc>:
{
  ...
  printf("balloc: out of blocks\n");
    ...
    800031f8:	36450513          	addi	a0,a0,868 # 80008558 <syscalls+0x108>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    800032e6:	28e50513          	addi	a0,a0,654 # 80008570 <syscalls+0x120>
...
00000000800032f2 <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    8000330a:	d8250513          	addi	a0,a0,-638 # 8001f088 <itable>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    8000331c:	d8848493          	addi	s1,s1,-632 # 8001f0a0 <itable+0x18>
    80003320:	0001e697          	auipc	a3,0x1e
    80003324:	81068693          	addi	a3,a3,-2032 # 80020b30 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80003350:	d3c50513          	addi	a0,a0,-708 # 8001f088 <itable>
  ...
  release(&itable.lock);
    ...
    80003380:	d0c50513          	addi	a0,a0,-756 # 8001f088 <itable>
    ...
    800033a2:	1ea50513          	addi	a0,a0,490 # 80008588 <syscalls+0x138>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    800033ce:	c9e98993          	addi	s3,s3,-866 # 8001f068 <sb>
  ...
  initlog(dev, &sb);
    ...
    80003402:	c6a58593          	addi	a1,a1,-918 # 8001f068 <sb>
    ...
    80003422:	17a50513          	addi	a0,a0,378 # 80008598 <syscalls+0x148>
...
000000008000342e <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80003440:	17458593          	addi	a1,a1,372 # 800085b0 <syscalls+0x160>
    80003444:	0001c517          	auipc	a0,0x1c
    80003448:	c4450513          	addi	a0,a0,-956 # 8001f088 <itable>
    8000344c:	ffffd097          	auipc	ra,0xffffd
    80003450:	6fa080e7          	jalr	1786(ra) # 80000b46 <initlock>
  for(i = 0; i < NINODE; i++) {
    80003454:	0001c497          	auipc	s1,0x1c
    80003458:	c5c48493          	addi	s1,s1,-932 # 8001f0b0 <itable+0x28>
    8000345c:	0001d997          	auipc	s3,0x1d
    80003460:	6e498993          	addi	s3,s3,1764 # 80020b40 <log+0x10>
    initsleeplock(&itable.inode[i].lock, "inode");
    80003464:	00005917          	auipc	s2,0x5
    80003468:	15490913          	addi	s2,s2,340 # 800085b8 <syscalls+0x168>
...
000000008000348e <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    800034a8:	bd072703          	lw	a4,-1072(a4) # 8001f074 <sb+0xc>
    ...
    800034bc:	bb0a0a13          	addi	s4,s4,-1104 # 8001f068 <sb>
  ...
  printf("ialloc: no inodes\n");
    ...
    80003506:	0be50513          	addi	a0,a0,190 # 800085c0 <syscalls+0x170>
...
0000000080003560 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80003578:	b0c5a583          	lw	a1,-1268(a1) # 8001f080 <sb+0x18>
...
00000000800035ee <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    800035fe:	a8e50513          	addi	a0,a0,-1394 # 8001f088 <itable>
  ...
  release(&itable.lock);
    ...
    80003614:	a7850513          	addi	a0,a0,-1416 # 8001f088 <itable>
...
000000008000362c <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80003660:	f7c50513          	addi	a0,a0,-132 # 800085d8 <syscalls+0x188>
    ...
    80003676:	a0e5a583          	lw	a1,-1522(a1) # 8001f080 <sb+0x18>
    ...
    800036e2:	f0250513          	addi	a0,a0,-254 # 800085e0 <syscalls+0x190>
...
00000000800036ee <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    8000372e:	ec650513          	addi	a0,a0,-314 # 800085f0 <syscalls+0x1a0>
...
00000000800037e6 <iput>:
{
  ...
  release(&itable.lock);
    ...
    80003816:	87650513          	addi	a0,a0,-1930 # 8001f088 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    8000384a:	84250513          	addi	a0,a0,-1982 # 8001f088 <itable>
    ...
    80003880:	80c50513          	addi	a0,a0,-2036 # 8001f088 <itable>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003b3e:	abe50513          	addi	a0,a0,-1346 # 800085f8 <syscalls+0x1a8>
    80003b42:	ffffd097          	auipc	ra,0xffffd
    80003b46:	9fe080e7          	jalr	-1538(ra) # 80000540 <panic>
      panic("dirlookup read");
    80003b4a:	00005517          	auipc	a0,0x5
    80003b4e:	ac650513          	addi	a0,a0,-1338 # 80008610 <syscalls+0x1c0>
...
0000000080003d26 <dirlink>:
{
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80003dcc:	85850513          	addi	a0,a0,-1960 # 80008620 <syscalls+0x1d0>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    80003e22:	d1290913          	addi	s2,s2,-750 # 80020b30 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003e46:	d1e78793          	addi	a5,a5,-738 # 80020b60 <log+0x30>
    ...
    80003e5c:	d0c60613          	addi	a2,a2,-756 # 80020b64 <log+0x34>
...
0000000080003e8e <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003e92:	cce7a783          	lw	a5,-818(a5) # 80020b5c <log+0x2c>
    80003e96:	0af05d63          	blez	a5,80003f50 <install_trans+0xc2>
{
    ...
    80003eb4:	cb0a8a93          	addi	s5,s5,-848 # 80020b60 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003eb8:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003eba:	0001d997          	auipc	s3,0x1d
    80003ebe:	c7698993          	addi	s3,s3,-906 # 80020b30 <log>
...
0000000080003f52 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003f68:	bcc48493          	addi	s1,s1,-1076 # 80020b30 <log>
    80003f6c:	00004597          	auipc	a1,0x4
    80003f70:	6c458593          	addi	a1,a1,1732 # 80008630 <syscalls+0x1e0>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003fa8:	bbc70713          	addi	a4,a4,-1092 # 80020b60 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    80003fde:	b807a123          	sw	zero,-1150(a5) # 80020b5c <log+0x2c>
...
begin_op(void)
{
  ...
  while(1){
    ...
    8000405c:	ad850513          	addi	a0,a0,-1320 # 80020b30 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    8000408c:	aa848493          	addi	s1,s1,-1368 # 80020b30 <log>
  ...
  if(log.outstanding == 0){
    ...
    800040b0:	a8448493          	addi	s1,s1,-1404 # 80020b30 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800040cc:	a6848493          	addi	s1,s1,-1432 # 80020b30 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80004136:	a2ea8a93          	addi	s5,s5,-1490 # 80020b60 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    8000413a:	0001da17          	auipc	s4,0x1d
    8000413e:	9f6a0a13          	addi	s4,s4,-1546 # 80020b30 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800041c0:	9a07a023          	sw	zero,-1632(a5) # 80020b5c <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800041e0:	95490913          	addi	s2,s2,-1708 # 80020b30 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000421e:	94670713          	addi	a4,a4,-1722 # 80020b60 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    8000423a:	8fa78793          	addi	a5,a5,-1798 # 80020b30 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    80004262:	3ea50513          	addi	a0,a0,1002 # 80008648 <syscalls+0x1f8>
    80004266:	ffffc097          	auipc	ra,0xffffc
    8000426a:	2da080e7          	jalr	730(ra) # 80000540 <panic>
    panic("log_write outside of trans");
    8000426e:	00004517          	auipc	a0,0x4
    80004272:	3f250513          	addi	a0,a0,1010 # 80008660 <syscalls+0x210>
  ...
  log.lh.block[i] = b->blockno;
    ...
    80004288:	8ac70713          	addi	a4,a4,-1876 # 80020b30 <log>
  ...
  release(&log.lock);
    ...
    8000429a:	89a50513          	addi	a0,a0,-1894 # 80020b30 <log>
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    800042c6:	3be58593          	addi	a1,a1,958 # 80008680 <syscalls+0x230>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800043e8:	2ac58593          	addi	a1,a1,684 # 80008690 <syscalls+0x240>
    800043ec:	0001d517          	auipc	a0,0x1d
    800043f0:	88c50513          	addi	a0,a0,-1908 # 80020c78 <ftable>
...
filealloc(void)
{
  ...
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    ...
    80004422:	87248493          	addi	s1,s1,-1934 # 80020c90 <ftable+0x18>
    80004426:	0001e717          	auipc	a4,0x1e
    8000442a:	80a70713          	addi	a4,a4,-2038 # 80021c30 <disk>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    ...
    8000443e:	83e50513          	addi	a0,a0,-1986 # 80020c78 <ftable>
  ...
  return 0;
    ...
    80004456:	82650513          	addi	a0,a0,-2010 # 80020c78 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    8000447e:	7fe50513          	addi	a0,a0,2046 # 80020c78 <ftable>
  ...
  release(&ftable.lock);
    ...
    80004498:	7e450513          	addi	a0,a0,2020 # 80020c78 <ftable>
  ...
  return f;
    ...
    800044b4:	1e850513          	addi	a0,a0,488 # 80008698 <syscalls+0x248>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800044d8:	7a450513          	addi	a0,a0,1956 # 80020c78 <ftable>
  ...
  release(&ftable.lock);
    ...
    80004512:	76a50513          	addi	a0,a0,1898 # 80020c78 <ftable>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    8000468e:	54e70713          	addi	a4,a4,1358 # 80020bd8 <devsw>
    ...
    800046a4:	01050513          	addi	a0,a0,16 # 800086b0 <syscalls+0x260>
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    8000472e:	4ae70713          	addi	a4,a4,1198 # 80020bd8 <devsw>
  ...
  return ret;
    ...
    800047d8:	eec50513          	addi	a0,a0,-276 # 800086c0 <syscalls+0x270>
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80004848:	e8c58593          	addi	a1,a1,-372 # 800086d0 <syscalls+0x280>
...
loadseg(pagetable_t pagetable, uint64 va, struct inode *ip, uint offset, uint sz)
{
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004c3c:	aa050513          	addi	a0,a0,-1376 # 800086d8 <syscalls+0x288>
...
argfd(int n, int *pfd, struct file **pf)
{
  ...
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    ...
    80004f2a:	01a70793          	addi	a5,a4,26 # fffffffffffff01a <end+0xffffffff7ffdd2aa>
...
create(char *path, short type, short major, short minor)
{
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    80005000:	044ad783          	lhu	a5,68(s5) # fffffffffffff044 <end+0xffffffff7ffdd2d4>
  ...
  return ip;
    ...
    800050a6:	65658593          	addi	a1,a1,1622 # 800086f8 <syscalls+0x2a8>
    ...
    800050be:	64658593          	addi	a1,a1,1606 # 80008700 <syscalls+0x2b0>
...
0000000080005404 <sys_unlink>:
{
  ...
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    ...
    80005450:	2ac58593          	addi	a1,a1,684 # 800086f8 <syscalls+0x2a8>
    ...
    80005468:	29c58593          	addi	a1,a1,668 # 80008700 <syscalls+0x2b0>
  ...
  return 0;
    ...
    80005528:	1e450513          	addi	a0,a0,484 # 80008708 <syscalls+0x2b8>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80005574:	1b050513          	addi	a0,a0,432 # 80008720 <syscalls+0x2d0>
    80005578:	ffffb097          	auipc	ra,0xffffb
    8000557c:	fc8080e7          	jalr	-56(ra) # 80000540 <panic>
    panic("unlink: writei");
    80005580:	00003517          	auipc	a0,0x3
    80005584:	1b850513          	addi	a0,a0,440 # 80008738 <syscalls+0x2e8>
...
free_desc(int i)
{
  ...
  if(disk.free[i])
    ...
    80005c78:	fbc78793          	addi	a5,a5,-68 # 80021c30 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    80005c8c:	fa878793          	addi	a5,a5,-88 # 80021c30 <disk>
  ...
  wakeup(&disk.free[0]);
    ...
    80005cb4:	f9850513          	addi	a0,a0,-104 # 80021c48 <disk+0x18>
...
0000000080005ce8 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005d00:	05c50513          	addi	a0,a0,92 # 80021d58 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_DRIVER_FEATURES) = features;
    ...
    80005d64:	75f68693          	addi	a3,a3,1887 # ffffffffc7ffe75f <end+0xffffffff47fdc9ef>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    80005daa:	e8a48493          	addi	s1,s1,-374 # 80021c30 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    80005dce:	e6e73703          	ld	a4,-402(a4) # 80021c38 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    ...
    80005de6:	e4e48493          	addi	s1,s1,-434 # 80021c30 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80005f06:	e5650513          	addi	a0,a0,-426 # 80021d58 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005f1a:	d1ab8b93          	addi	s7,s7,-742 # 80021c30 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    80005f24:	e38c8c93          	addi	s9,s9,-456 # 80021d58 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005f46:	cee70713          	addi	a4,a4,-786 # 80021c30 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005f7e:	cce50513          	addi	a0,a0,-818 # 80021c48 <disk+0x18>
    ...
    80005f8a:	f8040a13          	addi	s4,s0,-128
{
  ...
  if(write)
    ...
    80005fa2:	c9278793          	addi	a5,a5,-878 # 80021c30 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80006078:	ce490913          	addi	s2,s2,-796 # 80021d58 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    800060a4:	b9078793          	addi	a5,a5,-1136 # 80021c30 <disk>
    800060a8:	97ba                	add	a5,a5,a4
    800060aa:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    800060ae:	0001c997          	auipc	s3,0x1c
    800060b2:	b8298993          	addi	s3,s3,-1150 # 80021c30 <disk>
  ...
  release(&disk.vdisk_lock);
    ...
    800060da:	c8250513          	addi	a0,a0,-894 # 80021d58 <disk+0x128>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80006112:	b2248493          	addi	s1,s1,-1246 # 80021c30 <disk>
    80006116:	0001c517          	auipc	a0,0x1c
    8000611a:	c4250513          	addi	a0,a0,-958 # 80021d58 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80006192:	bca50513          	addi	a0,a0,-1078 # 80021d58 <disk+0x128>
    ...
    800061ac:	68850513          	addi	a0,a0,1672 # 80008830 <syscalls+0x3e0>
    800061b0:	ffffa097          	auipc	ra,0xffffa
    800061b4:	390080e7          	jalr	912(ra) # 80000540 <panic>

00000000800061b8 <sys_add>:
#include "types.h"
#include "riscv.h"
#include "defs.h"
...
uint64 sys_add(void)
{
  ...
  argint(0, &a);
    ...
    800061ca:	8fc080e7          	jalr	-1796(ra) # 80002ac2 <argint>
  argint(1, &b);
    800061ce:	fe840593          	addi	a1,s0,-24
    800061d2:	4505                	li	a0,1
    800061d4:	ffffd097          	auipc	ra,0xffffd
    800061d8:	8ee080e7          	jalr	-1810(ra) # 80002ac2 <argint>
  return a + b;
    800061dc:	fec42783          	lw	a5,-20(s0)
    800061e0:	fe842503          	lw	a0,-24(s0)
}
    800061e4:	9d3d                	addw	a0,a0,a5
